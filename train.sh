...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --config-file configs/zero3.yaml --num_processes 8 verifiers/examples/trl_stage_3_think.py \
    ...
    --max_completion_length 4096 --hub_model_id Menlo/noname-1.7B-thinking-v0.3 --wandb_project lucy --max_steps_env 20 \
    --run_name lucy-2507 --save_steps 20 \
    --temperature 0.7 --top_p 0.8 --top_k 20 --min_p 0  --reward_correct_answer 1 --warmup_steps 32 --max_steps 640 --num_train_epochs 2
